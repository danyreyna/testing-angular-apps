...
- It’s important to **clean up before each** test
...
- angular testing library has a bug where it doesn't accept [SomeService] in component providers
  - it explicitly needs [{provide: SomeService}]
  - https://github.com/testing-library/angular-testing-library/blob/31ad7ceba8e79d9c921d6f0800fa6cb7629924f0/projects/testing-library/src/lib/testing-library.ts#L123
  - even the only example in the docs uses [AppComponentService]
  - https://testing-library.com/docs/angular-testing-library/api#componentproviders
- bookshelf tests 13
- bookshelf tests 14
...
- https://github.com/angular/angular/blob/main/packages/platform-browser/src/browser/tools/common_tools.ts
  - https://github.com/angular/angular/blob/main/packages/core/src/application/application_ref.ts#L488
  - https://github.com/angular/angular/blob/main/packages/platform-browser/src/browser/tools/tools.ts#L29
